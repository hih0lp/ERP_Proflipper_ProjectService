...
namespace ERP_Proflipper_WorkspaceService.Controllers
{
    public class ProjectController : Controller
    {
        ...
        public async Task<IActionResult> CreateProject() //�������� �������� � ���� �� ����� ��
        {
            ...
            var id = await _projectService.CreateProjectInDB(project, parsedUserModel["login"].ToString()); //���� ��� ����� ����
        ...
        public async Task<IActionResult> SendToApproveWithOpenAccess()
        {
            try
            {
                ...
                var content = CreateContentWithURI("������ ��������� �� ������������!", $"ProjectsAndDeals/projectCard?id={project.Id}");
        ...
        public async Task<IActionResult> DisapproveProject(string projectId) //string role, string userLogin
        {
            try ///TODO : ������ ����� ������ �� �������� ����� ����. ������ �� �������� ���� ��� ��� ��� 
            {
                ...
                if (userParsedModel["gendirRole"].ToObject<bool>() == false)
                    if (!userParsedModel["login"].ToObject<string>().Equals(dbProject.RolesLogins.BuilderLogin) && //��� ����� ������ � ������ (��� � ������ EDITPROJECTASYNC, ������ ����������������)
            ...
            try
            {
                ...
                if (userParsedModel["gendirRole"].ToObject<bool>() == false)
                    if (!userParsedModel["login"].ToObject<string>().Equals(project.RolesLogins.BuilderLogin) &&
                        !userParsedModel["login"].ToObject<string>().Equals(project.RolesLogins.LawyerLogin) && //����� ��� �������� ����, �������� �� ���� ���� �� ����� �� ������������� �� ������
        ...
        public async Task<IActionResult> ToApproveProject(string projectId)
        {
            try
            {
                ...
                _logger.LogInformation(userParsedModel["gendirRole"].ToObject<bool>().ToString());

                if (userParsedModel["gendirRole"].ToObject<bool>() == true)
                {
                    dbProject.NowStatus = "In Progress"; //���� ��������� ������, �� ����� �� in progress
                ...
                if (dbProject.BuilderStatus == "Approved" && dbProject.LawyerStatus == "Approved" && dbProject.FinancierStatus == "Approved")
                {
                    ...
                    if (genDir["login"].ToString().IsNullOrEmpty()) return BadRequest("����� �� ���� ���-���� �� ����������");
                ...
                //await _projectService.EditProjectAsync(project);//, null, null //�������� ���� �������� �� ���� � ������ (����� ���� �����, ������ ����� ��������)
                return Ok();
